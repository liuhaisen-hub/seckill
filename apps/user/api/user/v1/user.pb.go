...
type CreateUserRequest struct {
	...
	Emali         string                 `protobuf:"bytes,3,opt,name=emali,proto3" json:"emali,omitempty"`
...
func (x *CreateUserRequest) GetEmali() string {
	if x != nil {
		return x.Emali
	}
	return ""
...
func (x *GetAuthUserRequest) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
func (x *GetAuthUserRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *GetAuthUserReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAuthUserReply) ProtoMessage() {}

func (x *GetAuthUserReply) ProtoReflect() protoreflect.Message {
	mi := &file_user_v1_user_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAuthUserReply.ProtoReflect.Descriptor instead.
func (*GetAuthUserReply) Descriptor() ([]byte, []int) {
	return file_user_v1_user_proto_rawDescGZIP(), []int{11}
}

func (x *GetAuthUserReply) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetAuthUserReply) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
func (x *GetAuthUserReply) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\bListUser\x12\x1c.api.user.v1.ListUserRequest\x1a\x1a.api.user.v1.ListUserReply\x12M\n" +
	"\vGetAuthUser\x12\x1f.api.user.v1.GetAuthUserRequest\x1a\x1d.api.user.v1.GetAuthUserReplyB$\n" +
...
var file_user_v1_user_proto_goTypes = []any{
	...
	(*GetAuthUserRequest)(nil), // 10: api.user.v1.GetAuthUserRequest
	(*GetAuthUserReply)(nil),   // 11: api.user.v1.GetAuthUserReply
}
var file_user_v1_user_proto_depIdxs = []int32{
	...
	10, // 5: api.user.v1.User.GetAuthUser:input_type -> api.user.v1.GetAuthUserRequest
	...
	11, // 11: api.user.v1.User.GetAuthUser:output_type -> api.user.v1.GetAuthUserReply
